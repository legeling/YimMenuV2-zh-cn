...
5. 更新合入记录。官方基线变化和提前吸收的官方 PR 都必须写入 `docs/maintenance/downstream-integrations.md`，至少记录来源链接、锁定 SHA、中文提交、验证边界和当前状态。若改动影响游戏版本兼容性或具体功能，还要同步更新 `docs/compatibility/` 或 `docs/features/` 中的对应文档。
