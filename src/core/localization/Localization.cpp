...
namespace YimMenu::Localization
{
	namespace
	{
		...
		const std::unordered_map<std::string_view, std::string_view> g_Translations = {
		    ...
		    {"Freecam Speed"sv, "自由镜头速度"sv},
		    {"How fast the freecam will move positions"sv, "自由镜头移动位置的速度"sv},
		    {"Noclip Speed"sv, "穿墙速度"sv},
		    {"Weapon Damage Scale"sv, "武器伤害倍率"sv},
		    {"Sets the damage scale for weapons (including melee)"sv, "设置武器伤害倍率（包含近战）"sv},
		    {"Locally Visible"sv, "本地可见"sv},
		    ...
		    {"The model name of the ped you wish to spawn."sv, "你想生成的 NPC 模型名称。"sv},
		    {"Object Model"sv, "物体模型"sv},
		    {"The model name of the object you wish to spawn."sv, "你想生成的物体模型名称。"sv},
		    {"Hour"sv, "小时"sv},
		    {"Minute"sv, "分钟"sv},
